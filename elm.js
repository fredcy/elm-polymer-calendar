...
var _user$project$JsonDateDecode$toDate = _user$project$Native_JsonDateDecode.toDate;

var _user$project$Main$datePicker = _elm_lang$html$Html$node('paper-date-picker');
var _user$project$Main$detailValue = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['detail', 'value']),
	_elm_lang$core$Json_Decode$value);
var _user$project$Main$onValueChanged = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'date-changed',
		A2(_elm_lang$core$Json_Decode$map, tagger, _user$project$Main$detailValue));
};
var _user$project$Main$valueToDate = function (val) {
	var dateResult = A2(
		_elm_lang$core$Debug$log,
		'dateResult',
		_user$project$JsonDateDecode$toDate(val));
	return dateResult;
};
var _user$project$Main$day = 24 * _elm_lang$core$Time$hour;
var _user$project$Main$addTime = F2(
	function (time, date) {
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'UpdateDate':
				return _p0._0;
			case 'AddADay':
				return A2(_user$project$Main$addTime, _user$project$Main$day, model);
			case 'Add30Days':
				return A2(_user$project$Main$addTime, 30 * _user$project$Main$day, model);
			default:
				return A2(
					_elm_lang$core$Result$withDefault,
					model,
					_user$project$JsonDateDecode$toDate(_p0._0));
		}
	});
var _user$project$Main$nowCmd = function (tagger) {
	return A3(
...
var _user$project$Main$DateChanged = function (a) {
	return {ctor: 'DateChanged', _0: a};
};
var _user$project$Main$Add30Days = {ctor: 'Add30Days'};
var _user$project$Main$AddADay = {ctor: 'AddADay'};
var _user$project$Main$view = function (model) {
	var dateString = A2(_mgold$elm_date_format$Date_Format$format, '%Y-%m-%d %H:%M:%S', model);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$AddADay)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add a Day')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$Add30Days)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add 30 Days')
					])),
				A2(
				...
				A2(
				_user$project$Main$datePicker,
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$html$Html_Attributes$attribute, 'date', dateString),
						_user$project$Main$onValueChanged(_user$project$Main$DateChanged)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _user$project$Main$init = {
	...
	_1: _user$project$Main$nowCmd(_user$project$Main$UpdateDate)
};
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			update: F2(
				function (msg, m) {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Main$update, msg, m),
