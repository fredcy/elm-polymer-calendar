...
var _user$project$JsonDateDecode$toJson = _user$project$Native_JsonDateDecode.toJson;
...
var _user$project$Main$dateValue = A2(_elm_lang$core$Json_Decode$customDecoder, _user$project$Main$detailValue, _user$project$JsonDateDecode$toDate);
...
var _user$project$Main$view = function (model) {
	var dateString = _user$project$JsonDateDecode$toJson(model);
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$on,
						'date-changed',
						A2(_elm_lang$core$Json_Decode$map, _user$project$Main$DateChanged, _user$project$Main$dateValue))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
